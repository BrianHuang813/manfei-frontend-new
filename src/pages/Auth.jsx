      ...
      <div className="max-w-md w-full mx-4">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-6 py-4 bg-line text-white rounded-lg hover:bg-line/90 transition-colors font-medium shadow-md hover:shadow-lg"
          >

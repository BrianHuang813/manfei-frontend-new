...
export default function Navbar() {
  ...
  // Close mobile menu and user dropdown on ESC
  ...
  // Dismiss the user dropdown on any click outside it
  useEffect(() => {
  ...
  return (
    <>
      <motion.nav
        ...
        className={cn(
          'fixed top-0 left-0 right-0 z-50 transition-[background-color,box-shadow,backdrop-filter] duration-500',
          scrolled
        ...
        <div className="container-custom flex items-center justify-between h-16 md:h-20">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            {isAuthenticated ? (
              <div className="relative" ref={userMenuRef}>
                <button
                  ...
                  aria-haspopup="menu"
                  className={cn(
                    'flex items-center gap-2 px-4 py-2 text-sm tracking-wider border rounded-full transition-colors duration-300',
                    scrolled
              ...
              <Link
                to="/login"
                className={cn(
                  'flex items-center gap-2 px-5 py-2 text-sm tracking-wider border rounded-full transition-colors duration-300',
                  scrolled
                    ? 'border-gold text-gold hover:bg-gold hover:text-white'
                    : 'border-white/70 text-white hover:bg-white hover:text-secondary'
                )}
            ...
            <a
              ...
              className={cn(
                'px-5 py-2 text-sm tracking-wider border rounded-full transition-colors duration-300',
                scrolled
                  ? 'border-gold text-gold hover:bg-gold hover:text-white'
                  : 'border-white/70 text-white hover:bg-white hover:text-secondary'
              )}
          ...
          <button
            ...
            className={cn(
              'lg:hidden -mr-2.5 h-11 w-11 inline-flex items-center justify-center transition-colors',
              scrolled ? 'text-secondary' : 'text-white'
            )}
            aria-label="開啟選單"
          >
      ...
      <AnimatePresence>
        {mobileOpen && (
          ...
          >
            ...
            <button
              onClick={closeMobile}
              className="absolute top-4 right-4 h-11 w-11 inline-flex items-center justify-center text-secondary hover:text-gold transition-colors z-10"
              aria-label="關閉選單"
            >
              <X size={28} />
            </button>
            ...
            <div className="flex-1 flex flex-col items-center justify-center gap-7">
              ...
              <motion.a
                ...
                className="mt-2 px-8 py-3 border border-gold text-gold rounded-full text-lg tracking-wider hover:bg-gold hover:text-white transition-colors"
              >
                立即預約
              </motion.a>
            </div>
